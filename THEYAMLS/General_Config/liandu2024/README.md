...
#### 📝 clash-fallback.yaml
- **路径**: `clash-fallback.yaml` | **大小**: 15.9 KB | [查看源码](https://github.com/Upsi1on/mihomo_yamls/blob/main/THEYAMLS/General_Config/liandu2024/clash-fallback.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
- **路径**: `clash-fallback-all.yaml` | **大小**: 18.6 KB | [查看源码](https://github.com/Upsi1on/mihomo_yamls/blob/main/THEYAMLS/General_Config/liandu2024/clash-fallback-all.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
